...
#Analyzing number of rides across different months (monthly)
...
x= biketype_memberstatus_pivoted.plot(kind='bar', stacked=True, figsize=(10, 6))
def format_yticks(y, pos):
    return '{:.0f}K'.format(y / 1000)

x.yaxis.set_major_formatter(FuncFormatter(format_yticks))
